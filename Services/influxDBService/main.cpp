...
int main() {
    registerEndpoint("fluxQuery", "POST", executeFluxQuery);
    registerEndpoint("exampleFunction", "GET", exampleFunction);

    try {
        boost::asio::io_service io_service;
        tcp::acceptor acceptor(io_service, tcp::endpoint(tcp::v4(), 1010));
